<?php
   ...
   */
require_once 'init\post_type.php';

add_shortcode('viewShortcode','get_index');

function get_index(){
$pPath = plugin_dir_path( __FILE__ );
//    return file_get_contents($pPath .'/view/index.php', true);
    ob_start();
    include_once( $pPath.'/view/index.php');
